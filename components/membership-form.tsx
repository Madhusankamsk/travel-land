...
export function MembershipForm({
  ...
  return (
    <form onSubmit={onSubmit} className="flex flex-col gap-8">
      {/* 1. Personal details */}
      <section className="rounded-[20px] border border-[var(--color-bone)] bg-white p-6 shadow-[var(--shadow-sm)]">
          ...
          <div className="sm:col-span-2">
            ...
            <select
              ...
              onChange={(e) => {
                ...
                if (pkg) {
                  const addSingle = data.roomType === "Single" ? Number(pkg.singleSupplement ?? 0) : 0;
