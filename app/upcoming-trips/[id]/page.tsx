      ...
      <div className="mx-auto max-w-5xl px-4 py-10">
        ...
        <div className="overflow-hidden rounded-2xl border border-zinc-200 bg-white shadow-sm">
          ...
          <div className="space-y-10 p-6 sm:p-8">
            ...
            <section className="grid gap-8 md:grid-cols-[minmax(0,2fr)_minmax(260px,1fr)]">
              ...
              <aside className="space-y-6 rounded-xl border border-zinc-200 bg-zinc-50 p-4 sm:p-5">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-wide text-zinc-500">
                    Price from
                  </p>
                ...
                {staff.length > 0 && (
                  <div className="border-t border-zinc-200 pt-4 text-sm text-zinc-700">
