...
export default function SustainableTourismPage() {
  return (
    <main className="min-h-screen bg-travertine">
      ...
      >
        <div className="mx-auto max-w-[1200px] px-6 lg:px-20">
          ...
          <h1
            ...
            <h3 className="mb-4 text-[13px] font-semibold uppercase tracking-[0.16em] text-terracotta">
              Key principles
            </h3>
            <ul className="flex flex-wrap justify-center gap-3 text-left text-[13px] leading-relaxed text-[#7A7060]">
              <li className="inline-flex items-center rounded-full border border-bone bg-travertine px-4 py-2 shadow-[var(--shadow-sm)]">
      ...
      <section className="bg-travertine py-16 lg:py-24" aria-labelledby="our-commitment-title">
        <div className="mx-auto max-w-[1200px] px-6 lg:px-20">
          <div>
            <div className="mb-6 flex justify-center">
              <Image
                src="/Logo.png"
                alt="TRAVEL-LAND.IT logo"
                width={220}
                height={64}
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <div className="rounded-[16px] bg-white/80 p-4">
                ...
                <p className="text-[14px] leading-relaxed text-[#7A7060]">
                  Our tours encourage travelers to appreciate and respect local traditions, customs,
      ...
      <section
        className="relative overflow-hidden bg-obsidian py-16 lg:py-24"
